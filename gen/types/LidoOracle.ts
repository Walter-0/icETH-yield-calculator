...
export interface AllowedBeaconBalanceAnnualRelativeIncreaseSetEventObject {
  value: BigNumber;
}
export type AllowedBeaconBalanceAnnualRelativeIncreaseSetEvent = TypedEvent<
  [BigNumber],
  AllowedBeaconBalanceAnnualRelativeIncreaseSetEventObject
>;
...
export interface AllowedBeaconBalanceRelativeDecreaseSetEventObject {
  value: BigNumber;
}
export type AllowedBeaconBalanceRelativeDecreaseSetEvent = TypedEvent<
  [BigNumber],
  AllowedBeaconBalanceRelativeDecreaseSetEventObject
>;
...
export interface BeaconReportReceiverSetEventObject {
  callback: string;
}
export type BeaconReportReceiverSetEvent = TypedEvent<
  [string],
  BeaconReportReceiverSetEventObject
>;
...
export interface PostTotalSharesEventObject {
