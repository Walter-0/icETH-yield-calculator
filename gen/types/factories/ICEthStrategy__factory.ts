...
export class ICEthStrategy__factory {
  static readonly abi = _abi;
  static createInterface(): ICEthStrategyInterface {
    return new utils.Interface(_abi) as ICEthStrategyInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ICEthStrategy {
    return new Contract(address, _abi, signerOrProvider) as ICEthStrategy;
  }
}
