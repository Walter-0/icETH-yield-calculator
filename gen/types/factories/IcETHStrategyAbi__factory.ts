...
import type {
  IcETHStrategyAbi,
  IcETHStrategyAbiInterface,
  AaveLeverageStrategyExtension,
} from "../IcETHStrategyAbi";
...
const _abi = [
  {
    inputs: [
      ...
      },
      {
        components: [
          ...
          },
          {
            ...
            name: "targetCollateralAToken",
            type: "address",
          },
          {
            internalType: "contract IERC20",
            name: "targetBorrowDebtToken",
            type: "address",
          },
          {
        ...
        internalType: "struct AaveLeverageStrategyExtension.ContractSettings",
        name: "_strategy",
        type: "tuple",
      },
      {
        ...
        internalType:
          "struct AaveLeverageStrategyExtension.MethodologySettings",
        name: "_methodology",
        type: "tuple",
      },
      {
        ...
        internalType: "struct AaveLeverageStrategyExtension.ExecutionSettings",
        name: "_execution",
        type: "tuple",
      },
      {
        ...
        internalType: "struct AaveLeverageStrategyExtension.IncentiveSettings",
        name: "_incentive",
        type: "tuple",
      },
      {
      ...
      },
      {
        ...
        internalType: "struct AaveLeverageStrategyExtension.ExchangeSettings[]",
  ...
  },
  {
    ...
    outputs: [
      ...
      {
        internalType: "enum AaveLeverageStrategyExtension.ShouldRebalance[]",
        name: "",
        type: "uint8[]",
      },
    ],
...
export class IcETHStrategyAbi__factory {
  static readonly abi = _abi;
  static createInterface(): IcETHStrategyAbiInterface {
    return new utils.Interface(_abi) as IcETHStrategyAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IcETHStrategyAbi {
    return new Contract(address, _abi, signerOrProvider) as IcETHStrategyAbi;
  }
}
